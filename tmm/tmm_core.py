"""
Original at: https://github.com/qpv-research-group/solcore5/blob/develop/solcore/absorption_calculator/tmm_core_vec.py
...
def snell(n_1, n_2, th_1):
    ...
    """
    # Important that the arcsin here is scimath.arcsin, not numpy.arcsin!! (They
